...
@DisplayName("restapi :: service :: businessRules :: TeacherBr")
public class TeacherBrTest {
    ...
    public void validateEntityExistsException() {
        try {
            ...
            Assertions.assertEquals("Teacher", e.getParams()[1]);
        } catch (Exception e) {
            Assertions.fail(e);
        }
    }
    ...
    public void validateNameExistsException() {
        try {
            ...
            Assertions.assertTrue(e.getParams() != null && e.getParams().length > 0);
            Assertions.assertEquals(2, e.getParams().length);
            Assertions.assertEquals("Teacher", e.getParams()[0]);
