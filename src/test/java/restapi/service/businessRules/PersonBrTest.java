...
@DisplayName("restapi :: service :: businessRules :: PersonBr")
public class PersonBrTest {
    ...
    public void validateEntityExistsException() {
        try {
            ...
            Assertions.assertEquals("Person", e.getParams()[1]);
        } catch (Exception e) {
            Assertions.fail(e);
        }
    }
    ...
    public void validateNameExistsException() {
        try {
            ...
            Assertions.assertTrue(e.getParams() != null && e.getParams().length > 0);
            Assertions.assertEquals(2, e.getParams().length);
            Assertions.assertEquals("Person", e.getParams()[0]);
